...
def register_i18n(app):
    ...
    def inject_i18n():
        ...
        from app.utils.seo import canonical_url, hreflang_alternates, site_base_url, global_site_json_ld_script
        ...
        return {
            ...
            "global_site_json_ld_script": lambda: global_site_json_ld_script(lang),
